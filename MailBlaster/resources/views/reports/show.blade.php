{{-- filepath: MailBlaster/resources/views/reports/show.blade.php --}}
@extends('layouts.admin')

@section('admin-content')
    <h1 class="text-2xl font-bold mb-4">Detalle de campaña: {{ $campaign->name }}</h1>
    <div class="mb-4">
        ...
        <span class="bg-blue-100 text-blue-800 px-2 py-1 rounded">Estado: {{ ucfirst($campaign->status) }}</span>
    </div>
